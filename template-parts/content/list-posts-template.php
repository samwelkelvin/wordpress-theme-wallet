                                    ...
                                    <article class="blog-post">
                                        ...
                                        <?php if ($featuredImage) { ?>
                                            <div class="post-slider slider-sm rounded slick-initialized slick-slider">
                                                <div class="slick-list draggable mb-3">
                                                    <div class="slick-track" style="opacity: 1; display:block;">
                                                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                                                            <img loading="lazy" decoding="async" src="<?php echo $featuredImage; ?>" alt="<?php the_title(); ?>" class="slick-slide slick-cloned w-100" data-slick-index="-1" id="" aria-hidden="true" tabindex="-1" style="max-width: 100%;max-height: 500px;">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-0">
                                            <span>
                                                ...
                                                <?php echo get_the_author_posts_link(); ?> (<?php echo count_user_posts(get_the_author_meta('ID')); ?> Posts)
