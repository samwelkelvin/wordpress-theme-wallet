...
if (!class_exists('WP_Bootstrap_Navwalker_Footer')) {
	...
	class WP_Bootstrap_Navwalker_Footer extends Walker_Nav_Menu
	{
		...
		public static function fallback($args)
		{
			...
			$fallback_output .= '<li class="list-inline-item me-4"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="text-black" title="' . esc_attr__('Add a menu', 'wp-bootstrap-navwalker') . '">' . esc_html__('Add a menu', 'wp-bootstrap-navwalker') . '</a></li>';
			$fallback_output .= '</ul>';
		...
		public function add_schema_to_navbar_ul($args)
		{
			if (isset($args['items_wrap'])) {
				...
				if (false === strpos($wrap, 'SiteNavigationElement')) {
