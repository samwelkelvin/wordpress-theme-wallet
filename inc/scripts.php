...
function wallet_load_styles()
{
   ...
   wp_register_style('wallet-additional-style', THEME_DIR_URI . "/assets/css/additional.css", [], filemtime(get_template_directory() . "/assets/css/additional.css"), 'all');

   wp_enqueue_style('google-fonts', "https://fonts.googleapis.com/css2?family=Rubik:wght@400;500;700&display=swap", [], THEME_VERSION, 'all');

   wp_register_style('wallet-main-style',THEME_DIR_URI . "/assets/css/style.css", [], filemtime(get_template_directory() . "/assets/css/style.css"), 'all');

   wp_register_style('wallet-slick-style', THEME_DIR_URI . "/assets/plugins/slick/slick.css", [], filemtime(get_template_directory() . "/assets/plugins/slick/slick.css"), 'all');
   wp_register_style('wallet-font-awsome', THEME_DIR_URI . "/assets/plugins/font-awesome/fontawesome.min.css", [], filemtime(get_template_directory() . "/assets/plugins/font-awesome/fontawesome.min.css"), 'all');
   wp_register_style('wallet-font-awsome-brands', THEME_DIR_URI . "/assets/plugins/font-awesome/brands.css", [], filemtime(get_template_directory() . "/assets/plugins/font-awesome/brands.css"), 'all');
   wp_register_style('wallet-font-awsome-solid', THEME_DIR_URI . "/assets/plugins/font-awesome/solid.css", [], filemtime(get_template_directory() . "/assets/plugins/font-awesome/solid.css"), 'all');
...
function wallet_load_scripts(){
   ...
   wp_register_script("wallet-jquery",THEME_DIR_URI. "/assets/plugins/jquery/jquery.min.js",[],filemtime(get_template_directory(). "/assets/plugins/jquery/jquery.min.js"),true);
   wp_register_script("wallet-bootsrapt-js", THEME_DIR_URI . "/assets/plugins/bootstrap/bootstrap.min.js", ["wallet-jquery"], filemtime(get_template_directory() . "/assets/plugins/bootstrap/bootstrap.min.js"), true);
   wp_register_script("wallet-slick-js", THEME_DIR_URI . "/assets/plugins/slick/slick.min.js", ["wallet-jquery"], filemtime(get_template_directory() . "/assets/plugins/slick/slick.min.js"), true);
   wp_register_script("wallet-scroll", THEME_DIR_URI . "/assets/plugins/scrollmenu/scrollmenu.min.js", ['wallet-jquery'], filemtime(get_template_directory() . "/assets/plugins/scrollmenu/scrollmenu.min.js"), true);
   
   wp_register_script("wallet-main-js", THEME_DIR_URI . "/assets/js/script.js", ["wallet-jquery"], filemtime(get_template_directory() . "/assets/js/script.js"), true);
